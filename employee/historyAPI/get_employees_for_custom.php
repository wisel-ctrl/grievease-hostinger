...
if (isset($_GET['customsales_id'])) {
    $serviceId = $_GET['customsales_id'];
    debug_log("Received customsales_id", $serviceId);
    ...
    if ($branchResult->num_rows > 0) {
        ...
        debug_log("No branch found for customsales_id", $serviceId);
    }
    ...
    debug_log("No customsales_id provided in request");
