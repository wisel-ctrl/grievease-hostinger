        ...
        <div class="w-full md:w-1/2 max-w-md mx-auto">
            <div class="bg-white bg-opacity-95 backdrop-blur-sm rounded-xl p-6 shadow-card">
                <div class="text-center mb-4">
                    <h2 class="text-xl font-hedvig font-bold text-navy">Member Login</h2>
                </div>
                ...
                <div class="text-center mt-4">
                    <p class="text-xs font-medium">
                        Need an Account? <a href="register.php" class="text-yellow-600 font-semibold hover:underline">Get Started</a>
                    </p>
                </div>
            </div>
        </div>
