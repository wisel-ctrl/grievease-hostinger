...
function generateInventoryRow($row) {
    ...
    $html .= '<td class="p-2 text-sm align-middle">';  // Changed p-4 to p-2 and added align-middle
$html .= '<div class="flex space-x-2 h-full items-center">';  // Added h-full and items-center
