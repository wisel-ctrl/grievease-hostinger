    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
        ...
        <div>
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                ...
                <input type="text" id="total_value" name="total_value" step="0.01" class="pl-7 block w-full px-3 py-2 bg-white border border-gold rounded-md shadow-sm text-gray-700 focus:outline-none focus:ring-dark-gold focus:border-dark-gold" value="₱<?php echo number_format($item["total_value"], 2); ?>" >
            </div>
        </div>
    </div>
