...
$html .= '<button class="w-6 h-6 flex items-center justify-center bg-yellow-100 text-yellow-600 rounded hover:bg-yellow-200 transition-all tooltip" title="Edit Item" onclick="openViewItemModal(' . $row["inventory_id"] . ')">';
...
$html .= '<button type="submit" class="w-8 h-8 flex items-center justify-center bg-red-100 text-red-600 rounded hover:bg-red-200 transition-all tooltip" title="Archive Item">';
$html .= '<i class="fas fa-archive text-sm"></i>';
$html .= '</button>';
$html .= '</form>';
$html .= '</div>';
$html .= '</td>';
