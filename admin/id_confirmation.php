...
// Apply validation to ID verification search inputs
document.addEventListener('DOMContentLoaded', function() {
    // ID verification search inputs
    const idSearchInput = document.getElementById('idSearchInput');
    const mobileIdSearchInput = document.getElementById('mobileIdSearchInput');
    
    // Apply validation to search inputs
    validateSearchInput(idSearchInput);
    validateSearchInput(mobileIdSearchInput);
});
</script>
