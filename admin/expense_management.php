...
<div class="mb-6">
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
    <!-- Total Expenses Card -->
    <div class="bg-white rounded-md shadow-sidebar p-4 border border-sidebar-border hover:shadow-card transition-all duration-300">
      <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 rounded-md bg-blue-100 text-sidebar-accent flex items-center justify-center">
          <i class="fas fa-peso-sign text-base"></i>
        </div>
        <span class="text-sidebar-text text-sm font-medium">Total Expenses</span>
      </div>
      <div class="text-2xl font-bold text-sidebar-text">₱<?php echo $totalAmount; ?></div>
      <div class="text-xs <?php echo $trendClass; ?> flex items-center mt-1">
    ...
    <div class="bg-white rounded-md shadow-sidebar p-4 border border-sidebar-border hover:shadow-card transition-all duration-300">
      <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 rounded-md bg-yellow-100 text-sidebar-accent flex items-center justify-center">
          <i class="fas fa-wallet text-base"></i>
        </div>
        <span class="text-sidebar-text text-sm font-medium">Budget Status</span>
      </div>
      
      <div class="flex items-center justify-between mb-1">
        <div class="text-lg font-bold text-sidebar-text <?php echo $warningLevel; ?>">
      ...
      <div class="w-full bg-gray-200 rounded-full h-2 mb-1">
        <div class="bg-sidebar-accent h-2 rounded-full" style="width: <?php echo $percentageUsed; ?>%"></div>
      </div>
      ...
      <div class="mt-1 text-xs bg-yellow-100 text-darkgold p-1 rounded text-center">
        <i class="fas fa-exclamation-triangle mr-1"></i> <?php echo ($percentageUsed >= 100) ? 'Budget exceeded!' : 'Near limit'; ?>
      </div>
      <?php endif; ?>
    </div>
    ...
    <div class="bg-white rounded-md shadow-sidebar p-4 border border-sidebar-border hover:shadow-card transition-all duration-300">
      <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 rounded-md bg-orange-100 text-orange-600 flex items-center justify-center">
          <i class="fas fa-exclamation-triangle text-base"></i>
        </div>
        <div>
          <span class="text-sidebar-text text-sm font-medium">Overdue</span>
          <div class="text-xs text-gray-500">₱<?php echo number_format($overdueAmount, 2); ?></div>
        </div>
      </div>
      
      <div class="text-2xl font-bold text-sidebar-text mb-1"><?php echo $overdueCount; ?></div>
      
      <!-- Urgency breakdown -->
      <div class="grid grid-cols-4 gap-1 text-xs">
        <div class="text-center">
          <div class="text-error font-medium"><?php echo $urgencyData['critical'] ?? 0; ?></div>
    ...
    <div class="bg-white rounded-md shadow-sidebar p-4 border border-sidebar-border hover:shadow-card transition-all duration-300">
      <div class="flex items-center gap-3 mb-2">
        <div class="w-10 h-10 rounded-md bg-purple-100 text-purple-600 flex items-center justify-center">
          <i class="fas fa-calendar-alt text-base"></i>
        </div>
        <div>
          <span class="text-sidebar-text text-sm font-medium">Upcoming</span>
          <?php if ($nearestDate): ?>
      ...
      <div class="text-2xl font-bold text-sidebar-text mb-1"><?php echo $upcomingCount; ?></div>
