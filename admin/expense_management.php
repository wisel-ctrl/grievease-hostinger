  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
    <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex items-center">
      ...
      <div>
        ...
        <p class="text-lg font-semibold">₱<?php echo $totalAmount; ?></p>
        <p class="text-xs <?php echo $trendClass; ?> flex items-center">
    ...
    <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex items-center">
      ...
      <div class="w-full">
        <p class="text-xs text-gray-500">Monthly Budget Status</p>
        <div class="flex items-end justify-between mb-1">
          <p class="text-lg font-semibold <?php echo $warningLevel; ?>">
            ₱<?php echo number_format($currentSpend, 2); ?>
          </p>
          <p class="text-xs text-gray-500">of ₱<?php echo number_format($monthlyBudget, 2); ?> budget</p>
        </div>
        ...
        <div class="flex justify-between items-center text-xs">
          <span class="<?php echo $daysLeftClass; ?> flex items-center">
            <i class="fas fa-clock mr-1"></i> <?php echo $daysLeft; ?> days remaining
          </span>
          <span class="<?php echo $warningLevel; ?>">
    ...
    <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex items-center">
      ...
      <div class="w-full">
        <div class="flex justify-between">
          ...
          <p class="text-xs text-gray-500">Total: ₱<?php echo number_format($overdueAmount, 2); ?></p>
        </div>
        <p class="text-lg font-semibold"><?php echo $overdueCount; ?></p>
        
        <!-- Urgency breakdown -->
        <div class="grid grid-cols-4 gap-2 mb-1 text-xs">
    ...
    <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex items-center">
      <div class="p-3 bg-purple-100 text-purple-600 rounded-full mr-3">
        <i class="fas fa-calendar-alt"></i>
      </div>
      <div>
        <div class="flex flex-col">
          <p class="text-xs text-gray-500">Upcoming Payments</p>
          <?php if ($nearestDate): ?>
          <p class="text-xs text-gray-500">Next due: <?php echo date('M j', strtotime($nearestDate)); ?></p>
          <?php endif; ?>
        </div>
        <p class="text-lg font-semibold"><?php echo $upcomingCount; ?></p>
