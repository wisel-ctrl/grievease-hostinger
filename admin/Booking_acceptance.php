...
<div class="sticky bottom-0 left-0 right-0 px-4 py-3.5 border-t border-sidebar-border bg-white flex flex-col sm:flex-row justify-between items-center gap-4">
    ...
    <div id="paginationContainer" class="flex items-center justify-center space-x-2">
    <?php if ($total_pages > 1): ?>
        <!-- First page button (double arrow) -->
        <a href="?page=1" class="flex items-center justify-center w-9 h-9 border border-sidebar-border rounded text-sm hover:bg-sidebar-hover <?php echo ($current_page == 1) ? 'opacity-50 pointer-events-none' : ''; ?>">
            <i class="fas fa-angle-double-left"></i>
        </a>
        
        <!-- Previous page button (single arrow) -->
        <a href="<?php echo '?page=' . max(1, $current_page - 1); ?>" class="flex items-center justify-center w-9 h-9 border border-sidebar-border rounded text-sm hover:bg-sidebar-hover <?php echo ($current_page == 1) ? 'opacity-50 pointer-events-none' : ''; ?>">
        ...
        for ($i = $start_page; $i <= $end_page; $i++) {
            ...
            echo '<a href="?page=' . $i . '" class="flex items-center justify-center w-9 h-9 rounded text-sm ' . $active_class . '">' . $i . '</a>';
        }
        ?>
        
        <!-- Next page button (single arrow) -->
        <a href="<?php echo '?page=' . min($total_pages, $current_page + 1); ?>" class="flex items-center justify-center w-9 h-9 border border-sidebar-border rounded text-sm hover:bg-sidebar-hover <?php echo ($current_page == $total_pages) ? 'opacity-50 pointer-events-none' : ''; ?>">
            <i class="fas fa-chevron-right"></i>
        </a>
        
        <!-- Last page button (double arrow) -->
        <a href="<?php echo '?page=' . $total_pages; ?>" class="flex items-center justify-center w-9 h-9 border border-sidebar-border rounded text-sm hover:bg-sidebar-hover <?php echo ($current_page == $total_pages) ? 'opacity-50 pointer-events-none' : ''; ?>">
