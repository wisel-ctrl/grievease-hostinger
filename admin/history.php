...
<div class="bg-white rounded-lg shadow-md mb-8 border border-sidebar-border overflow-hidden branch-container">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-3 w-full md:w-auto">
            ...
            <div class="relative w-full md:w-64">
                <input type="text" id="searchOngoing" 
                       ...
                       oninput="debouncedFilter('ongoing')">
    ...
    <!-- Services Table -->
    <div class="overflow-x-auto scrollbar-thin" id="tableContainerOngoing">
        <div id="loadingIndicatorOngoing" class="hidden absolute inset-0 bg-white bg-opacity-50 flex items-center justify-center">
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b border-sidebar-border">
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('ongoing', 0)">
                        <div class="flex items-center">
                            <i class="fas fa-hashtag mr-1.5 text-sidebar-accent"></i> ID 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('ongoing', 1)">
                        <div class="flex items-center">
                            <i class="fas fa-user mr-1.5 text-sidebar-accent"></i> Client Name 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('ongoing', 2)">
                        <div class="flex items-center">
                            <i class="fas fa-user-circle mr-1.5 text-sidebar-accent"></i> Deceased Name 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('ongoing', 3)">
                        <div class="flex items-center">
                            <i class="fas fa-tag mr-1.5 text-sidebar-accent"></i> Service Type 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('ongoing', 4)">
                        <div class="flex items-center">
                            <i class="fas fa-calendar mr-1.5 text-sidebar-accent"></i> Date of Burial 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('ongoing', 5)">
                        <div class="flex items-center">
                            <i class="fas fa-toggle-on mr-1.5 text-sidebar-accent"></i> Status 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('ongoing', 6)">
                        <div class="flex items-center">
            ...
            <tbody>
                ...
                <tr class="border-b border-sidebar-border hover:bg-sidebar-hover transition-colors">
                    ...
                    <td class="p-4 text-sm">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-500 border border-orange-200">
                    ...
                    <td class="p-4 text-sm">
                        <div class="flex space-x-2">
                            ...
                            <button class="p-2 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 transition-all tooltip" title="Assign Staff" onclick="openAssignStaffModal('<?php echo $row['sales_id']; ?>')">
                                <i class="fas fa-users"></i>
                            </button>
                            <?php endif; ?>
                            <button class="p-2 bg-purple-100 text-purple-600 rounded-lg hover:bg-purple-200 transition-all tooltip" title="Complete Service" onclick="openCompleteModal('<?php echo $row['sales_id']; ?>')">
...
<div class="bg-white rounded-lg shadow-md mb-8 border border-sidebar-border overflow-hidden branch-container">
    ...
    <div class="bg-sidebar-hover p-4 border-b border-sidebar-border flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <?php 
            // Count fully paid services
            $fullyPaidCount = $fullyPaidResult->num_rows;
            ?>
            <span class="bg-sidebar-accent bg-opacity-10 text-sidebar-accent px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                <i class="fas fa-clipboard-list"></i>
                <?php echo $fullyPaidCount . " Service" . ($fullyPaidCount != 1 ? "s" : ""); ?>
            </span>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-3 w-full md:w-auto">
            ...
            <div class="relative w-full md:w-64">
                <input type="text" id="searchFullyPaid" 
                       placeholder="Search services..." 
                       class="pl-8 pr-3 py-2 w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sidebar-accent"
                       oninput="debouncedFilter('fullyPaid')">
                <i class="fas fa-search absolute left-2.5 top-3 text-gray-400"></i>
            </div>
        </div>
    </div>
    ...
    <!-- Services Table -->
    <div class="overflow-x-auto scrollbar-thin" id="tableContainerFullyPaid">
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b border-sidebar-border">
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('fullyPaid', 0)">
                        <div class="flex items-center">
                            <i class="fas fa-hashtag mr-1.5 text-sidebar-accent"></i> ID 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('fullyPaid', 1)">
                        <div class="flex items-center">
                            <i class="fas fa-user mr-1.5 text-sidebar-accent"></i> Client Name 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('fullyPaid', 2)">
                        <div class="flex items-center">
                            <i class="fas fa-user-circle mr-1.5 text-sidebar-accent"></i> Deceased Name 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('fullyPaid', 3)">
                        <div class="flex items-center">
                            <i class="fas fa-tag mr-1.5 text-sidebar-accent"></i> Service Type 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('fullyPaid', 4)">
                        <div class="flex items-center">
                            <i class="fas fa-calendar mr-1.5 text-sidebar-accent"></i> Date of Burial 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('fullyPaid', 5)">
                        <div class="flex items-center">
                            <i class="fas fa-toggle-on mr-1.5 text-sidebar-accent"></i> Status 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
            ...
            <tbody>
                ...
                // Reset the pointer to the beginning of the result set
                if ($fullyPaidResult) {
                    $fullyPaidResult->data_seek(0);
                }
                
                if ($fullyPaidResult && $fullyPaidResult->num_rows > 0) {
...
<div class="bg-white rounded-lg shadow-md mb-8 border border-sidebar-border overflow-hidden branch-container">
    ...
    <div class="bg-sidebar-hover p-4 border-b border-sidebar-border flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex items-center gap-3">
            <h4 class="text-lg font-bold text-sidebar-text">Past Services - With Outstanding Balance</h4>
            
            <?php 
            // Count services with balance
            $withBalanceCount = $withBalanceResult->num_rows;
            ?>
            <span class="bg-sidebar-accent bg-opacity-10 text-sidebar-accent px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                <i class="fas fa-clipboard-list"></i>
                <?php echo $withBalanceCount . " Service" . ($withBalanceCount != 1 ? "s" : ""); ?>
            </span>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-3 w-full md:w-auto">
            ...
            <div class="relative w-full md:w-64">
                <input type="text" id="searchOutstanding" 
                       placeholder="Search services..." 
                       class="pl-8 pr-3 py-2 w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sidebar-accent"
                       oninput="debouncedFilter('withBalance')">
                <i class="fas fa-search absolute left-2.5 top-3 text-gray-400"></i>
            </div>
        </div>
    </div>
    ...
    <!-- Services Table -->
    <div class="overflow-x-auto scrollbar-thin" id="tableContainerWithBalance">
        <div id="loadingIndicatorWithBalance" class="hidden absolute inset-0 bg-white bg-opacity-50 flex items-center justify-center">
            <div class="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-sidebar-accent"></div>
        </div>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b border-sidebar-border">
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('withBalance', 0)">
                        <div class="flex items-center">
                            <i class="fas fa-hashtag mr-1.5 text-sidebar-accent"></i> ID 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('withBalance', 1)">
                        <div class="flex items-center">
                            <i class="fas fa-user mr-1.5 text-sidebar-accent"></i> Client Name 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('withBalance', 2)">
                        <div class="flex items-center">
                            <i class="fas fa-user-circle mr-1.5 text-sidebar-accent"></i> Deceased Name 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('withBalance', 3)">
                        <div class="flex items-center">
                            <i class="fas fa-tag mr-1.5 text-sidebar-accent"></i> Service Type 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('withBalance', 4)">
                        <div class="flex items-center">
                            <i class="fas fa-calendar mr-1.5 text-sidebar-accent"></i> Date of Burial 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('withBalance', 5)">
                        <div class="flex items-center">
                            <i class="fas fa-toggle-on mr-1.5 text-sidebar-accent"></i> Status 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('withBalance', 6)">
                        <div class="flex items-center">
                            <i class="fas fa-peso-sign mr-1.5 text-sidebar-accent"></i> Outstanding Balance 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
            ...
            <tbody>
                <?php
                // Reset the pointer to the beginning of the result set
                if ($withBalanceResult) {
                    $withBalanceResult->data_seek(0);
                }
                
                if ($withBalanceResult && $withBalanceResult->num_rows > 0) {
