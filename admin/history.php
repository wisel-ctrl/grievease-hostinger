...
<div class="bg-white rounded-lg shadow-md mb-8 border border-sidebar-border overflow-hidden">
    <div class="bg-sidebar-hover p-4 border-b border-sidebar-border flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <?php $ongoingCount = $ongoingResult->num_rows; ?>
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-3 w-full md:w-auto">
            ...
            <div class="relative w-full md:w-64">
                <input type="text" id="searchOngoing" 
                       ...
                       oninput="filterOngoingServices()">
                <i class="fas fa-search absolute left-2.5 top-3 text-gray-400"></i>
            </div>
        </div>
    </div>
    
    <div class="overflow-x-auto scrollbar-thin" id="ongoingTableContainer">
        ...
        <div class="p-4 border-t border-sidebar-border flex justify-between items-center">
            <div class="text-sm text-gray-500">
                Showing <?php echo $ongoingResult->num_rows; ?> ongoing services
            </div>
...
<div class="bg-white rounded-lg shadow-md mb-8 border border-sidebar-border overflow-hidden">
    <div class="bg-sidebar-hover p-4 border-b border-sidebar-border flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex items-center gap-3">
            <h3 class="text-lg font-bold text-sidebar-text">Past Services - Fully Paid</h3>
            <?php $fullyPaidCount = $fullyPaidResult->num_rows; ?>
            <span class="bg-sidebar-accent bg-opacity-10 text-sidebar-accent px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                <i class="fas fa-clipboard-list"></i>
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-3 w-full md:w-auto">
            ...
            <div class="relative w-full md:w-64">
                <input type="text" id="searchFullyPaid" 
                       placeholder="Search services..." 
                       class="pl-8 pr-3 py-2 w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sidebar-accent"
                       oninput="filterFullyPaidServices()">
                <i class="fas fa-search absolute left-2.5 top-3 text-gray-400"></i>
            </div>
        </div>
    </div>
    ...
    <div class="overflow-x-auto scrollbar-thin" id="fullyPaidTableContainer">
        ...
        <div class="p-4 border-t border-sidebar-border flex justify-between items-center">
            <div class="text-sm text-gray-500">
                Showing <?php echo $fullyPaidResult->num_rows; ?> fully paid services
            </div>
            <!-- Add pagination controls here if needed -->
        </div>
    </div>
...
<div class="bg-white rounded-lg shadow-md mb-8 border border-sidebar-border overflow-hidden">
    <div class="bg-sidebar-hover p-4 border-b border-sidebar-border flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <?php $withBalanceCount = $withBalanceResult->num_rows; ?>
            <span class="bg-sidebar-accent bg-opacity-10 text-sidebar-accent px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                <i class="fas fa-clipboard-list"></i>
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-3 w-full md:w-auto">
            ...
            <div class="relative w-full md:w-64">
                <input type="text" id="searchOutstanding" 
                       placeholder="Search services..." 
                       class="pl-8 pr-3 py-2 w-full border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sidebar-accent"
                       oninput="filterOutstandingServices()">
                <i class="fas fa-search absolute left-2.5 top-3 text-gray-400"></i>
            </div>
        </div>
    </div>
    ...
    <div class="overflow-x-auto scrollbar-thin" id="outstandingTableContainer">
        <div id="loadingIndicatorOutstanding" class="hidden absolute inset-0 bg-white bg-opacity-50 flex items-center justify-center">
            <div class="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-sidebar-accent"></div>
        </div>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b border-sidebar-border">
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('outstanding', 0)">
                        <div class="flex items-center">
                            <i class="fas fa-hashtag mr-1.5 text-sidebar-accent"></i> ID 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('outstanding', 1)">
                        <div class="flex items-center">
                            <i class="fas fa-user mr-1.5 text-sidebar-accent"></i> Client Name 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('outstanding', 2)">
                        <div class="flex items-center">
                            <i class="fas fa-user-alt mr-1.5 text-sidebar-accent"></i> Deceased Name 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('outstanding', 3)">
                        <div class="flex items-center">
                            <i class="fas fa-tag mr-1.5 text-sidebar-accent"></i> Service Type 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('outstanding', 4)">
                        <div class="flex items-center">
                            <i class="fas fa-calendar mr-1.5 text-sidebar-accent"></i> Date of Burial 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('outstanding', 5)">
                        <div class="flex items-center">
                            <i class="fas fa-toggle-on mr-1.5 text-sidebar-accent"></i> Status 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
                    </th>
                    <th class="p-4 text-left text-sm font-medium text-sidebar-text cursor-pointer" onclick="sortTable('outstanding', 6)">
                        <div class="flex items-center">
                            <i class="fas fa-peso-sign mr-1.5 text-sidebar-accent"></i> Outstanding Balance 
                            <i class="fas fa-sort ml-1 text-gray-400"></i>
                        </div>
        ...
        <div class="p-4 border-t border-sidebar-border flex justify-between items-center">
            <div class="text-sm text-gray-500">
                Showing <?php echo $withBalanceResult->num_rows; ?> services with outstanding balance
            </div>
            <!-- Add pagination controls here if needed -->
        </div>
    </div>
