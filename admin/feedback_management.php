...
<head>
    ...
    <style type="text/css">
        ...
        /* Custom styles from the original feedback_management.html */
        body {
...
<!-- Main Content -->
<div id="main-content" class="p-6 bg-navy min-h-screen transition-all duration-300 ml-64 w-[calc(100%-16rem)] main-content">
    
    <div class="flex justify-between items-center mb-6 bg-white p-5 rounded-xl shadow-sidebar border border-sidebar-border">
        <div>
            <h1 class="text-2xl font-bold text-sidebar-text font-playfair">Customer Feedback Management</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-card hover:shadow-lg transition-all duration-300 overflow-hidden col-span-1 lg:col-span-2">
            <div class="bg-gradient-to-r from-sidebar-accent/10 to-sidebar-accent/20 px-6 py-4">
                <div class="flex items-center justify-between mb-1">
                    <h3 class="text-lg font-medium text-sidebar-text flex items-center gap-2">
                        <i class="fas fa-star text-sidebar-accent"></i> Overall Average Rating
                    </h3>
                </div>
                <div class="flex items-end mt-2">
                    <span class="text-5xl font-extrabold text-gray-800 font-cinzel">4.7</span>
                    <span class="ml-3 text-lg font-semibold text-gray-600">/ 5.0</span>
                </div>
            ...
            <div class="px-6 py-3 bg-white border-t border-gray-100">
                <span class="text-xs text-gray-500">Based on <strong>342</strong> total submissions.</span>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-card mb-8 border border-sidebar-border overflow-hidden">
        <div class="bg-sidebar-hover p-4 border-b border-sidebar-border">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div class="flex items-center gap-3 mb-4 lg:mb-0">
                    ...
                    <span class="bg-sidebar-accent/10 text-sidebar-accent px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                        342 Total
                    </span>
                </div>
                
                <div class="flex items-center gap-3">
                    <select class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sidebar-accent">
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gray-50 border-b border-sidebar-border">
                            ...
                            <th class="px-4 py-3.5 text-left text-sm font-medium text-sidebar-text">
                                <div class="flex items-center gap-1.5">
                    ...
                    <tbody id="feedbackTableBody">
                        <tr class="border-b border-sidebar-border hover:bg-sidebar-hover transition-colors">
                            <td class="px-4 py-4 text-sm font-medium text-sidebar-text whitespace-nowrap">Jane Doe</td>
                            ...
                            <td class="px-4 py-4 text-sm text-sidebar-text max-w-xs truncate" title="The service was exceptional, highly recommend GrievEase to everyone!">
                        ...
                        <tr class="border-b border-sidebar-border hover:bg-sidebar-hover transition-colors">
                            <td class="px-4 py-4 text-sm font-medium text-sidebar-text whitespace-nowrap">John Smith</td>
                            <td class="px-4 py-4 text-sm text-yellow-600 whitespace-nowrap">
                                <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i> (4.0)
                            </td>
                            <td class="px-4 py-4 text-sm text-sidebar-text max-w-xs truncate" title="Good experience overall, but the initial response was a bit slow.">
                        ...
                        <tr class="border-b border-sidebar-border hover:bg-sidebar-hover transition-colors">
                            <td class="px-4 py-4 text-sm font-medium text-sidebar-text whitespace-nowrap">Alice Johnson</td>
                            <td class="px-4 py-4 text-sm text-yellow-600 whitespace-nowrap">
                            ...
                            <td class="px-4 py-4 text-sm text-sidebar-text max-w-xs truncate" title="It was okay. Could use better communication updates.">
                        ...
                        <tr class="border-b border-sidebar-border hover:bg-sidebar-hover transition-colors">
                            <td class="px-4 py-4 text-sm font-medium text-sidebar-text whitespace-nowrap">Bob Williams</td>
                            <td class="px-4 py-4 text-sm text-yellow-600 whitespace-nowrap">
                                <i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i> (1.0)
                            </td>
                            <td class="px-4 py-4 text-sm text-sidebar-text max-w-xs truncate" title="Very disappointed. Issue was not resolved.">
        ...
        <div class="sticky bottom-0 left-0 right-0 px-4 py-3.5 border-t border-sidebar-border bg-white flex flex-col sm:flex-row justify-between items-center gap-4">
            <div id="paginationInfo" class="text-sm text-gray-500 text-center sm:text-left">
                Showing <strong>1 - 10</strong> of <strong>342</strong> feedbacks
            </div>
    ...
    <footer class="bg-white rounded-xl shadow-sidebar border border-sidebar-border p-4 text-center text-sm text-gray-500 mt-8">
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-4 space-y-3">
                            <p class="text-sm font-medium text-gray-700">Customer: <span class="font-normal text-sidebar-text" id="modalCustomerName">Jane Doe</span></p>
                            ...
                            <div class="p-3 bg-gray-100 rounded-lg border border-gray-200">
                                ...
                                <p class="text-base text-sidebar-text" id="modalFeedbackContent">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('#feedbackTableBody tr').forEach(row => {
            ...
            const ratingText = row.cells[1].textContent.trim().match(/\((.*)\)/)[1];
