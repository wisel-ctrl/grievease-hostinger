...
<div id="addCustomerAccountModal" class="fixed inset-0 z-50 flex items-center justify-center hidden">
  ...
  <div class="relative bg-white rounded-xl shadow-card w-full max-w-5xl mx-4 z-10 transform transition-all duration-300 max-h-[90vh] overflow-y-auto">
    ...
    <!-- Modal Body -->
    <div class="px-6 py-5">
      <form id="addCustomerAccountForm" method="post" action="addCustomer/add_customer.php" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Left Column -->
        <div class="space-y-4">
          <div>
...
<div id="addEmployeeAccountModal" class="fixed inset-0 z-50 flex items-center justify-center hidden">
  ...
  <div class="relative bg-white rounded-xl shadow-card w-full max-w-5xl mx-4 z-10 transform transition-all duration-300 max-h-[90vh] overflow-y-auto">
    ...
    <!-- Modal Body -->
    <div class="px-6 py-5">
      <form id="addEmployeeAccountForm" method="post" action="addEmployee/add_employee.php" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Left Column -->
        <div class="space-y-4">
          <div>
