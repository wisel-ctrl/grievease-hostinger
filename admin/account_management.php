...
<div id="customer-account-management" class="bg-white rounded-lg shadow-md mb-8 border border-sidebar-border overflow-hidden">
  ...
  <div class="bg-sidebar-hover p-4 border-b border-sidebar-border">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
      <!-- Title and Counter on single line -->
      <div class="flex items-center gap-4 mb-4 lg:mb-0">
        ...
        <span class="bg-sidebar-accent bg-opacity-10 text-sidebar-accent px-3 py-2 rounded-full text-xs font-medium flex items-center gap-1 h-10 whitespace-nowrap">
          <i class="fas fa-users"></i>
          <?php echo $totalCustomers . " Customer" . ($totalCustomers != 1 ? "s" : ""); ?>
        </span>
      </div>
      
      <!-- Controls for big screens - aligned right with even spacing -->
      <div class="hidden lg:flex items-center gap-4">
        <!-- Search Input -->
        <div class="relative">
          <input type="text" id="customerSearchInput" 
                placeholder="Search customers..." 
                class="pl-8 pr-3 py-2 w-64 h-10 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sidebar-accent">
          <i class="fas fa-search absolute left-2.5 top-3 text-gray-400"></i>
        </div>

        <!-- Filter Dropdown -->
        <div class="relative filter-dropdown">
          <button id="filterToggle" class="px-3 py-2 border border-gray-300 rounded-lg text-sm flex items-center justify-center gap-2 hover:bg-sidebar-hover h-10 w-28">
        ...
        <!-- Archive Button -->
        <button class="px-4 py-2 border border-gray-300 rounded-lg text-sm flex items-center justify-center gap-2 hover:bg-sidebar-hover h-10 w-28">
          <i class="fas fa-archive text-sidebar-accent"></i>
          <span class="whitespace-nowrap">Archive</span>
        </button>

        <!-- Add Customer Button -->
        <button class="px-4 py-2 bg-sidebar-accent text-white rounded-lg text-sm flex items-center justify-center gap-2 hover:bg-darkgold transition-colors shadow-sm h-10 w-40" 
                onclick="openAddCustomerAccountModal()">
          <i class="fas fa-plus-circle"></i> <span class="whitespace-nowrap">Add Customer</span>
        </button>
      </div>
    </div>
    ...
    <div class="lg:hidden w-full mt-4">
      ...
      <div class="flex items-center w-full gap-3 mb-4">
        ...
        <div class="flex items-center gap-3">
          <!-- Filter Icon Button -->
          <div class="relative filter-dropdown">
            <button id="customerFilterToggle" class="w-10 h-10 flex items-center justify-center text-sidebar-accent">
      ...
      <table class="w-full">
        <thead>
          <tr class="bg-gray-50 border-b border-sidebar-border">
            <th class="px-4 py-3.5 text-left text-sm font-medium text-sidebar-text cursor-pointer w-1/6" onclick="sortTable(0)">
              <div class="flex items-center gap-1.5 whitespace-nowrap">
                <i class="fas fa-hashtag text-sidebar-accent"></i> ID 
                <i class="fas fa-sort ml-1 text-gray-400"></i>
              </div>
            </th>
            <th class="px-4 py-3.5 text-left text-sm font-medium text-sidebar-text cursor-pointer w-1/6" onclick="sortTable(1)">
              <div class="flex items-center gap-1.5 whitespace-nowrap">
                <i class="fas fa-user text-sidebar-accent"></i> Name 
                <i class="fas fa-sort ml-1 text-gray-400"></i>
              </div>
            </th>
            <th class="px-4 py-3.5 text-left text-sm font-medium text-sidebar-text cursor-pointer w-1/6" onclick="sortTable(2)">
              <div class="flex items-center gap-1.5 whitespace-nowrap">
                <i class="fas fa-envelope text-sidebar-accent"></i> Email 
                <i class="fas fa-sort ml-1 text-gray-400"></i>
              </div>
            </th>
            <th class="px-4 py-3.5 text-left text-sm font-medium text-sidebar-text cursor-pointer w-1/6" onclick="sortTable(3)">
              <div class="flex items-center gap-1.5 whitespace-nowrap">
                <i class="fas fa-user-tag text-sidebar-accent"></i> Role 
                <i class="fas fa-sort ml-1 text-gray-400"></i>
              </div>
            </th>
            <th class="px-4 py-3.5 text-left text-sm font-medium text-sidebar-text cursor-pointer w-1/6" onclick="sortTable(4)">
              <div class="flex items-center gap-1.5 whitespace-nowrap">
                <i class="fas fa-toggle-on text-sidebar-accent"></i> Status 
                <i class="fas fa-sort ml-1 text-gray-400"></i>
              </div>
            </th>
            <th class="px-4 py-3.5 text-left text-sm font-medium text-sidebar-text w-1/6">
              <div class="flex items-center gap-1.5 whitespace-nowrap">
    ...
    <div class="lg:hidden w-full mt-4">
      ...
      <div class="flex items-center w-full gap-3 mb-4">
        ...
        <div class="flex items-center gap-3">
          <!-- Filter Icon Button -->
          <div class="relative filter-dropdown">
            <button id="employeeFilterToggle" class="w-10 h-10 flex items-center justify-center text-sidebar-accent">
              <i class="fas fa-filter text-xl"></i>
              <span id="filterIndicator" class="hidden absolute top-1 right-1 h-2 w-2 bg-sidebar-accent rounded-full"></span>
            </button>
            
            <!-- Filter Window - Positioned below the icon -->
            <div id="employeeFilterDropdown" class="hidden absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg z-10 border border-sidebar-border p-4">
              <div class="space-y-4">
                <!-- Sort Options -->
                <div>
                  <h5 class="text-sm font-medium text-sidebar-text mb-2">Sort By</h5>
