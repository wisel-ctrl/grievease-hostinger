...
<body class="flex bg-navy font-inter">
    ...
    <div id="main-content" class="p-8 bg-navy min-h-screen transition-all duration-300 ml-64 w-[calc(100%-16rem)]">
        ...
        <div class="mb-10">
            ...
            <p class="text-dark text-lg font-inter">Manage your account details and payment options</p>
        </div>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-sidebar-bg rounded-2xl shadow-card p-8 border border-border">
            ...
            <div class="bg-sidebar-bg rounded-2xl shadow-card p-8 border border-border">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button id="open-gcash-modal" 
                            class="bg-sidebar-accent hover:bg-darkgold text-white py-3 px-6 rounded-xl transition-all duration-300 font-medium shadow-input hover:shadow-card transform hover:-translate-y-0.5">
                    ...
                    <?php else: ?>
                        ...
                        <?php if (count($gcash_qr_codes) > $display_limit): ?>
                            <div class="mt-6 text-center">
                                <button id="show-all-qr" class="bg-sidebar-accent hover:bg-darkgold text-white py-2 px-6 rounded-xl transition-all duration-300 font-medium shadow-input hover:shadow-card transform hover:-translate-y-0.5">
            ...
            <div id="gcash-modal" class="fixed inset-0 z-50 hidden overflow-y-auto">
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div class="inline-block align-bottom bg-sidebar-bg rounded-2xl shadow-card text-left overflow-hidden transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        <div class="px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-2xl font-semibold text-primary-foreground font-playfair">Add New GCash QR Code</h3>
                                <button id="close-gcash-modal" class="text-dark hover:text-sidebar-accent transition-colors duration-300">
                            ...
                            <form method="post" enctype="multipart/form-data" id="gcash-form">
                                ...
                                <div class="mt-6 flex justify-end space-x-3">
                                    <button type="button" id="cancel-gcash-modal"
                                            class="px-4 py-2 border border-input-border rounded-xl text-primary-foreground hover:bg-secondary transition-all duration-300 font-medium shadow-input">
                                        Cancel
                                    </button>
                                    <button type="submit" name="add_gcash_qr"
                                            class="bg-sidebar-accent hover:bg-darkgold text-white py-2 px-6 rounded-xl transition-all duration-300 font-medium shadow-input hover:shadow-card transform hover:-translate-y-0.5">
                                        <i class="fas fa-plus-circle mr-2"></i>
                                        Add QR Code
                                    </button>
                                </div>
    ...
    <script>
        ...
        const inputs = document.querySelectorAll('input[type="text"], input[type="email"], input[type="tel"], input[type="date"], input[type="password"], input[type="file"]');
        ...
        document.querySelectorAll('.tab-filter').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.querySelectorAll('.tab-filter').forEach(btn => {
                    ...
                    btn.classList.add('text-dark', 'hover:text-primary-foreground');
                });
