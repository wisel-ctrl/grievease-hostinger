...
<div class="bg-cream py-16 px-8 relative overflow-hidden" id="how-to-use">
    ...
    <!-- Footer -->
    <!-- Feedback Section -->
    <div class="bg-navy/5 py-16 px-6" id="feedback">
        <div class="max-w-4xl mx-auto">
            <h3 class="text-4xl font-hedvig text-navy text-center mb-4">Share Your Thoughts</h3>
            <p class="text-dark text-center mb-8 max-w-2xl mx-auto">We value your feedback. Share your experience with us or let us know how we can serve you better.</p>
            
            <form id="feedbackForm" class="bg-white p-8 rounded-xl shadow-lg">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="name" class="block text-dark font-medium mb-2">Your Name</label>
                        <input type="text" id="name" name="name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="Enter your name" required>
                    </div>
                    <div>
                        <label for="email" class="block text-dark font-medium mb-2">Email Address</label>
                        <input type="email" id="email" name="email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="your.email@example.com" required>
                    </div>
                </div>
                
                <div class="mb-6">
                    <label for="rating" class="block text-dark font-medium mb-2">Your Rating</label>
                    <div class="flex items-center space-x-1">
                        <input type="hidden" id="rating" name="rating" value="5">
                        <button type="button" class="text-2xl text-yellow-400 hover:text-yellow-600 focus:outline-none" data-rating="1">★</button>
                        <button type="button" class="text-2xl text-yellow-400 hover:text-yellow-600 focus:outline-none" data-rating="2">★</button>
                        <button type="button" class="text-2xl text-yellow-400 hover:text-yellow-600 focus:outline-none" data-rating="3">★</button>
                        <button type="button" class="text-2xl text-yellow-400 hover:text-yellow-600 focus:outline-none" data-rating="4">★</button>
                        <button type="button" class="text-2xl text-yellow-400 hover:text-yellow-600 focus:outline-none" data-rating="5">★</button>
                        <span class="ml-2 text-dark/70 text-sm">Click to rate</span>
                    </div>
                </div>
                
                <div class="mb-6">
                    <label for="message" class="block text-dark font-medium mb-2">Your Feedback</label>
                    <textarea id="message" name="message" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="Share your thoughts with us..." required></textarea>
                </div>
                
                <div class="text-center">
                    <button type="submit" class="bg-yellow-600 hover:bg-yellow-700 text-white font-medium py-2 px-8 rounded-lg transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:ring-opacity-50">
            ...
            <div id="successMessage" class="hidden mt-6 p-4 bg-green-100 border-l-4 border-green-500 text-green-700">
                <div class="flex items-center">
            ...
            star.addEventListener('click', function() {
                ...
                stars.forEach((s, index) => {
                    if (index < rating) {
                        ...
                        s.classList.remove('text-yellow-600');
                    }
                });
            });
