                        ...
                        <div class="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                            ...
                            <?php else: ?>
                                <div class="flex flex-col items-center justify-center py-10 px-4 border-2 border-dashed border-gray-300 rounded-lg text-center cursor-pointer hover:bg-gray-50 transition-colors"
                                    ...
                                    <p class="text-navy font-medium mb-1">No ID uploaded yet</p>
                                    <p class="text-gray-600 text-sm mb-4">Upload a valid ID to verify your account</p>
                                    <button class="px-4 py-2 bg-yellow-600 hover:bg-darkgold text-white rounded-md transition-colors flex items-center text-sm">
