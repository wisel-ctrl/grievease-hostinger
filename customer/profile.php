...
<div id="personal-info" class="tab-content">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
        ...
        <div class="bg-navy p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 tab-header">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto sm:space-x-3">
...
<button id="edit-profile-btn" class="w-full sm:w-auto px-4 py-2 bg-yellow-600 hover:bg-darkgold text-white rounded-lg transition-colors flex items-center justify-center text-sm sm:text-base">
