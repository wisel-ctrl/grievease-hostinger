            ...
            <div id="lifeplan-bookings-list" class="p-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-4">
                    ...
                    <div class="p-4 sm:p-6 space-y-3 sm:space-y-4">
                        ...
                        <div class="flex justify-end">
                            <button class="view-lifeplan-details bg-yellow-600/5 text-white px-3 py-1 rounded hover:bg-blue-600/10 transition text-sm mr-2" data-booking="<?php echo $booking['lpbooking_id']; ?>">
                                <i class="fas fa-file-alt mr-1"></i> View Details
                            </button>
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center justify-center w-full">
                                        <label for="id-upload" class="flex flex-col border-4 border-dashed border-gray-300 hover:bg-gray-50 hover:border-yellow-500 rounded-lg p-6 group text-center cursor-pointer transition-all duration-200 w-full">
