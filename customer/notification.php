    ...
    <div class="container mx-auto px-4 py-8 max-w-screen-xl mt-[var(--navbar-height)]">
        ...
        <div class="bg-dark rounded-xl py-8 px-6 mb-10">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-hedvig text-white mb-3">Notifications</h1>
                <p class="text-white text-lg max-w-2xl mx-auto">Stay updated with important information about your services and arrangements.</p>
