...
<div class="mb-3">
    ...
    <div class="grid grid-cols-1 gap-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
            <select id="traditionalDeceasedRegion" name="deceasedRegion" class="px-3 py-2 border border-input-border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600">
                <option value="">Select Region</option>
            </select>
            
            <select id="traditionalDeceasedProvince" name="deceasedProvince" disabled class="px-3 py-2 border border-input-border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600">
                <option value="">Select Province</option>
            </select>
            
            <select id="traditionalDeceasedCity" name="deceasedCity" disabled class="px-3 py-2 border border-input-border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600">
                <option value="">Select City/Municipality</option>
            </select>
            
            <select id="traditionalDeceasedBarangay" name="deceasedBarangay" disabled class="px-3 py-2 border border-input-border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600">
                <option value="">Select Barangay</option>
                    ...
                    <div class="border-b border-gray-200 pb-4 mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="border border-input-border bg-white rounded-lg p-3 focus-within:ring-2 focus-within:ring-yellow-600">
                                ...
                                <input type="file" id="traditionalGcashReceipt" name="gcashReceipt" accept=".pdf,.jpg,.jpeg,.png" required class="hidden">
                            </div>
                            <p class="text-xs text-gray-500 mt-1">Accepted formats: PDF, JPG, JPEG, PNG</p>
                        </div>
                    ...
                    <div class="border-b border-gray-200 pb-4 mb-4">
                        <h3 class="text-base md:text-lg font-hedvig text-navy mb-3 md:mb-4">Additional Options</h3>
...
// Apply name validation to the appropriate fields
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('traditionalDeceasedAddress').addEventListener('blur', function() {
...
<script>
// File upload handlers and QR code functionality
document.addEventListener('DOMContentLoaded', function() {
