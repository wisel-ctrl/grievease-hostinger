                    ...
                    <div class="mt-4 mb-4 border border-gray-200 rounded-lg p-4 bg-gray-50 terms-checkbox-container">
                        <div class="flex items-start">
                            ...
                            <label for="termsCheckbox" class="ml-3 text-sm">
                                <span class="block text-navy mb-1">I have read and agree to the <a href="#" class="text-yellow-600 hover:underline" id="viewPrivacyPolicy">Privacy Policy</a> and <a href="#" class="text-yellow-600 hover:underline" id="viewTermsOfService">Terms of Service</a>. <a href="lifeplancontract.php">LifePlan Contract</a> <span class="text-red-500">*</span></span>
